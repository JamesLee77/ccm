    ...
    <div style={guideStyles.page}>
      ...
      <div>
        ...
        <div style={{ display: 'flex', height: 80, marginBottom: 8 }}>
          {[
            ['#1A1D1A', 'Ink', '#F0EEE9'],
            ['#3D5A3A', 'Moss', '#F0EEE9'],
            ['#6E8A5A', 'Moss·L', '#1A1D1A'],
            ['#C87A4A', 'Clay', '#1A1D1A'],
            ['#E6E2D8', 'Paper·D', '#1A1D1A'],
            ['#F0EEE9', 'Paper', '#1A1D1A'],
          ].map(([hex, n, fg]) => (
            <div key={hex} style={{
              ...
              border: hex === '#F0EEE9' ? `1px solid ${T.rule}` : 'none',
            }}>
      ...
      <div>
        ...
        <div style={{ background: '#fff', border: `1px solid ${T.rule}`,
          ...
          {[
            ['A', '#1A1D1A', '#F0EEE9', 'DAC · mineralization · highest durability'],
            ['B', '#3D5A3A', '#F0EEE9', 'biochar · enhanced weathering'],
            ['C', '#6E8A5A', '#1A1D1A', 'reforestation · afforestation'],
            ['D', '#C9C4B6', '#1A1D1A', 'REDD+ · legacy methodologies'],
          ].map(([g, bg, fg, sub]) => (
