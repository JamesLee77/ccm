...
// Supports light + dark mode (dark default).

const earthLight = window.biTokens;
const earthDark = {
  paper:     '#15181a',
  paperDeep: '#1d2123',
  rule:      '#2c3134',
  ...
  <section style={{ ...S.section,
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 1,
      ...
      {[
        ...
        <div key={i} style={{ background: isDark ? '#0a0d0a' : earthLight.ink, padding: '32px 28px' }}>
          ...
          <div style={{ fontFamily: 'Fraunces', fontSize: 32,
            letterSpacing: '-0.02em', marginBottom: 16, color: earthLight.paper }}>{h}</div>
          <div style={{ fontFamily: 'Source Serif 4', fontSize: 14,
            color: '#bcbeb6', lineHeight: 1.55 }}>{b}</div>
        </div>
      ))}
    </div>
  </section>
    ...
    <section style={S.section}>
      ...
      <div style={{ background: S.surface, border: `1px solid ${T.rule}`,
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr',
          ...
          <div style={{ border: `1px solid ${T.rule}`, padding: 24,
            background: isDark ? '#0a0d0a' : earthLight.ink,
            color: earthLight.paper }}>
...
const Grades = ({ T, S }) => (
  <section style={S.section}>
    ...
    <div style={{ background: S.surface, border: `1px solid ${T.rule}` }}>
      {[
        ['A', 'Direct Air Capture · Mineralization', '1000+ yr', '5-of-7', '#0c0f10', '#f5f3ec'],
        ['B', 'Biochar · Enhanced Weathering', '100+ yr', '4-of-6', '#2dbf63', '#f5f3ec'],
        ['C', 'Reforestation · Afforestation', '40+ yr', '4-of-6', '#5fe089', '#0c0f10'],
        ['D', 'REDD+ · Legacy Methodologies', '10–40 yr', '3-of-5', '#c9c5b8', '#0c0f10'],
        ...
        <div key={g} style={{ display: 'grid',
          ...
          <div style={{ width: 64, height: 64, background: bg, color: fg,
            ...
            border: g === 'D' ? `1px solid ${earthLight.inkSoft}` : 'none' }}>{g}</div>
...
const LandingEarth = () => {
  ...
  const T = dark ? earthDark : earthLight;
