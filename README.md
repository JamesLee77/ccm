...
| 라운드 | 가격 | 수량 | 모집액 | Cliff | Vesting |
|--------|------|------|--------|-------|---------|
| Seed | $0.15 | 100M | $15.0M | 6개월 | 24개월 linear |
| Series A | $0.20 | 150M | $30.0M | 3개월 | 18개월 linear |
| **Total** | — | **250M** | **$45.0M** | — | — |

---

## 가격 모델 — 시나리오 분석 (2026~2030)

> ⚠️ **Disclaimer**: 아래 수치는 백서·덱의 자체 모델 기반 forward-looking projection입니다. **투자 권유나 가격 보장이 아닙니다.** 실제 가격은 시장 채택, 규제 환경, DeFi TVL, 매크로 등 다수 변수에 따라 크게 달라질 수 있으며 손실 가능성이 있습니다. 자세한 리스크는 백서 12장을 참조하세요.

| 시나리오 | Year 1 | Year 2 | Year 3 | Year 5 | Y5 / TGE |
|----------|--------|--------|--------|--------|----------|
| **Bear** | $0.15 | $0.18 | $0.25 | $0.40 | 2× |
| **Base** | $0.30 | $0.55 | $1.20 | $3.50 | 17.5× |
| **Bull** | $0.50 | $1.20 | $4.00 | $15.00 | 75× |

> TGE 기준가 $0.20 (Series A) · 로그 스케일

### 시나리오 가정

| | VCM 성장 | 시장 점유율 | DeFi TVL | 기타 |
|---|---|---|---|---|
| **Bull** | 8× | 10% | $500M | 빠른 표준 채택, 규제 우호 |
| **Base** | 6× | 5% | $200M | veCCM staking ratio 30% |
| **Bear** | — | — | — | 느린 채택, 규제 마찰, DeFi 분리 |

### Staking Pool — 가격 탄력적 Yield
...
- P_t = 2× TGE → 5% / 월
- P_t = 10× TGE → 1% / 월
- Pool 200M 소진 시 자동 sunset (24~36개월 예상)
